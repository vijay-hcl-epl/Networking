THIS IS NOT DONE BY MYSELF. I AM NOT THE OWNER FOR THESE EXAMPLES. THESE EXAMPLES HAVE BEEN TAKEN FROM GITHUB(FORGOT THE ID). I HAVE INCLUDED IN MY REPO FOR QUICK REFERENCE
